...
public class TagFlowLayout extends FlexboxLayout implements TagAdapter.OnAdapterDataChanged
{
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        Tools.logByWh("TagFlowLayout - onSizeChanged");
    ...
    private void viewClickableSet(final View view, final int position)
    {
        ...
        Tools.logByWh("TagFlowLayout - viewClickableSet");
        ...
        view.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Tools.logByWh("TagFlowLayout - viewClickableSet - onClick");
    ...
    private void doCustomSelect(View v, int position)
    {
        ...
        Tools.logByWh("TagFlowLayout - doCustomSelect");

        Tools.logByWh("TagFlowLayout - mCheckable = " + mCheckable);
    ...
    private void doSupportCheckable(View v, int position)
    {
        ...
        Tools.logByWh("TagFlowLayout - doSupportCheckable");
        ...
        Tools.logByWh("TagFlowLayout - doSupportCheckable - mSelectedItem = " + mSelectedItem);
    ...
    public void onChange()
    {
        ...
        Tools.logByWh("TagFlowLayout - onChange");
    ...
    protected Parcelable onSaveInstanceState()
    {
        ...
        Tools.logByWh("TagFlowLayout - onSaveInstanceState");
    ...
    protected void onRestoreInstanceState(Parcelable state)
    {
        ...
        Tools.logByWh("TagFlowLayout - onRestoreInstanceState");
